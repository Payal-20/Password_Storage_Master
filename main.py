...
class MainApplication:
    ...
    def __init__(self, master):
        ...
        self.userLabel = tk.Label(self.master, text="Enter User Name:", width=3, height=3, font=self.large_font)
        ...
        self.passwordLabel = tk.Label(self.master, text="Enter Password:", width=3, height=3, font=self.large_font)
        ...
        self.bottonLog = tk.Button(self.master, text="Enter", width=40, height=3, cursor="hand2", font=self.small_font, command=lambda:self.log_in())
    ...
    def passwordStorageWindow(self):
        ...
        self.addPasswordLabel = tk.Label(self.frame1, text="For New Password", font=self.large_font)
        ...
        self.nameLabel.config(fg="black", justify="left")
